# TruBit - a cryptocurrency implementation in less than 1500 lines of code

[![Build Status](https://travis-ci.org/conradoqg/TruBit.svg?branch=master)](https://travis-ci.org/conradoqg/TruBit) [![Coverage Status](https://coveralls.io/repos/github/conradoqg/TruBit/badge.svg?branch=master)](https://coveralls.io/github/conradoqg/TruBit?branch=master)
...
It's the starting point to interact with the TruBit, and every node provides a swagger API to make this interaction easier. Available endpoints:
...
# Run two nodes
$ node bin/TruBit.js -p 9898 --name 1
$ node bin/TruBit.js -p 3002 --name 2 --peers http://localhost:9898
...
$ curl -X POST --header 'Content-Type: application/json' -d '{ "password": "t t t t t" }' 'http://localhost:9898/operator/wallets'
...
$ curl -X POST --header 'Content-Type: application/json' --header 'password: t t t t t' 'http://localhost:9898/operator/wallets/a2fb4d3f93ea3d4624243c03f507295c0c7cb5b78291a651e5575dcd03dfeeeb/addresses'
...
$ curl -X POST --header 'Content-Type: application/json' -d '{ "rewardAddress": "e155df3a1bac05f88321b73931b48b54ea4300be9d1225e0b62638f537e5544c" }' 'http://localhost:9898/miner/mine'
{
    "index": 1,
    "nonce": 1,
...
$ curl -X GET --header 'Content-Type: application/json' 'http://localhost:9898/node/transactions/c3c1e6fbff949042b065dc9e22d065a54ab826595fd8877d2be8ddb8cbb0e27f/confirmations'
{"confirmations":1}

# Get address 1 balance
$ curl -X GET --header 'Content-Type: application/json' 'http://localhost:9898/operator/e155df3a1bac05f88321b73931b48b54ea4300be9d1225e0b62638f537e5544c/balance'
{"balance":9000000000}

# Get address 2 balance
$ curl -X GET --header 'Content-Type: application/json' 'http://localhost:9898/operator/c574de33acfd82f2146d2f45f37ce95b7bdca133b8ad310adbd46938c75992c8/balance'
{"balance":1000000000}

# Get unspent transactions for address 1
$ curl -X GET --header 'Content-Type: application/json' 'http://localhost:9898/blockchain/transactions/unspent?address=e155df3a1bac05f88321b73931b48b54ea4300be9d1225e0b62638f537e5544c'
[
  {
...
```sh
# Build the image
$ docker build . -t TruBit

# Run TruBit in a docker
$ ./dockerExec.sh

# Run TruBit in a docker using port 3002
$ ./dockerExec.sh -p 3002

# Run TruBit in a docker options
$ ./dockerExec.sh -h
...
$ node bin/TruBit.js -h
Usage: bin\TruBit.js [options]

Options:
  -a, --host       Host address. (localhost by default)
  -p, --port       HTTP port. (9898 by default)
...
```sh
# Cloning repository
$ git clone git@github.com:conradoqg/TruBit.git
$ cd TruBit
$ npm install
...
[![Twitter](https://img.shields.io/twitter/url/https/github.com/conradoqg/TruBit.svg?style=social)](https://twitter.com/intent/tweet?text=Check%20it%20out%3A%20TruBit%20-%20a%20cryptocurrency%20implementation%20in%20less%20than%201500%20lines%20of%20code&url=%5Bobject%20Object%5D)

[![GitHub license](https://img.shields.io/badge/license-Apache%202-blue.svg)](https://raw.githubusercontent.com/conradoqg/TruBit/master/LICENSE)
