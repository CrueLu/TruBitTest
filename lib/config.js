...
module.exports = {
    ...
    pow: {
        getDifficulty: (blocks, index) => {
            ...
            const POW_CURVE = 500000;

            // INFO: The difficulty is the formula that TruBit choose to check the proof a work, this number is later converted to base 16 to represent the minimal initial hash expected value.
