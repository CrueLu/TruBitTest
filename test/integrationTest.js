...
describe('Integration Test', () => {
    ...
    const createTruBit = (name, host, port, peers, removeData = true) => {
    ...
    step('start server 1', () => {
        return createTruBit(name1, 'localhost', 9898, [])
            .then((httpServer) => {
    ...
    step('start server 2', () => {
        return createTruBit(name2, 'localhost', 3002, [{ url: 'http://localhost:9898' }])
            .then((httpServer) => {
    ...
    describe('Complementary tests', () => {
        ...
        step('restart server 1', () => {
            return Promise.resolve()
                ...
                .then(() => {
                    return createTruBit(name1, 'localhost', 9898, [], false)
                        .then((httpServer) => {
                            context.httpServer1 = httpServer;
                        });
                });
